...
### 2. Resolving Theoretical Conflicts in Multi-Attribute Choice

**Challenge:** Real-world choices are complex, often involving outcomes that are both delayed and probabilistic. Three distinct theoretical frameworks offer mutually exclusive predictions for how delay and probability interact: (1) they are independent (multiplicative models), (2) they create a "steeper" interaction (additive models), or (3) they create a "shallower" interaction (single-process models). Resolving which model is correct is a central, unresolved question in decision science.

**Approach:** I developed a multi-pronged analytical approach to resolve this conflict. First, I created novel, model-agnostic methods—"model-based slicing" and "Conditional Area under the Curve"—to robustly test the competing qualitative predictions. Second, I conducted a formal mathematical analysis of Killeen's (2023a) complex additive model, demonstrating that it converges to a simpler, parsimonious multiplicative form. Third, I analyzed the "delay-probability asymmetry," a related puzzle, and showed it is not caused by probability becoming more salient, but by delay discounting becoming *shallower* (less steep) when uncertainty is introduced.

**Contribution:** This work clarifies the foundational relationship between delay and probability. It provides new, robust methods (Conditional AuC) for analyzing multi-attribute choice, simplifies the theoretical landscape by showing a complex additive model is descriptively equivalent to a simpler one, and provides an empirical explanation for the delay-probability asymmetry.
...
### 3. Optimizing Measurement Tools for Behavioral Economics

**Challenge:** Key measurement tools in behavioral economics faced two major barriers to impact: their scientific consistency across different versions was unverified, and their length made them inefficient for scalable online research.
...
<br>&nbsp;&nbsp;&nbsp; [View Paper](https://doi.org/10.1016/j.beproc.2023.104864) | [View GitHub Repository](https://github.com/haoranmattwan/discounting-delayed-gains-procedure-comparison-2023)
</p>
...
### 4. Modeling Foundational Economic Principles in Controlled Systems
